...
# Date: 20181023
# Last-modified: 
# This code will compare two distance wig files, retun distance residual bw file and residual histgram, always file2 (w2) -file1 (w1)
...
def Compare(first_wig,second_wig, hgenome, win,gap):
    ...
    '''calculate residuals between values from the two wig files'''
