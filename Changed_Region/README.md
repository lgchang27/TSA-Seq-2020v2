...
Take the bed files (K562-H1_maxmin_mergeAdjacent.bed and otherwayK562-H1_maxmin_mergeAdjacent.bed) for the changed domains between the two cell lines generated from the "Identify changed domains" step. Take the .wig files (TSA-Seq_hanning_20kbx21_maxmin.wig) generated from the "Rescale TSA-Seq scores" step for the two cell lines each with 2 biological replicates. Take the score-distance dictionary file generated from last step (K562_maxminVSdistance.dic). 
