...
Figures 3A,B (middle bars), Supplementary Figures 6A,B,D,E (middle bars), 8A-D (middle bars), 10 (panel middle bars) were generated from the _mergeAdjacent.bb files.
...
Figures 2D (middle P-value track), 3A (bottom), 3B (middle P-value track), Supplementary Figures 6A,D (bottom), 6B,E (middle P-value track), 8A,C (bottom), 8B,D (middle P-value tracks), 10 (P-value track in each panel) were generated by this code.
